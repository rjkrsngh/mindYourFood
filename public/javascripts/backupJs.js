...
//     destroyAllChildrenOfMealListDisplay(mealList);
...
// const destroyAllChildrenOfMealListDisplay = (mealList) => {
//     console.log('length of mealList before deleting:', mealList.children.length);
//     while (mealList.firstChild) {
//         mealList.removeChild(mealList.lastChild);
//     }
//     console.log('length of mealList after deleting:', mealList.children.length);
// }
...
//         destroyAllChildrenOfMealListDisplay(mealList);
//         createMealDispalyPanel(mealsOnThisDate, mealList);
//     }
// }
...
//     // If the user is looking at filtered meals result and wants to see the original meals list again
//     // let currentMealPanel = document.getElementById('mealList');
//     // if (usesFilteredMeals) {
//     //     currentMealPanel.style.display = 'none';
//     //     destroyAllChildrenOfMealListDisplay(currentMealPanel);
//     // }

//     // if (currentMealPanel.style.display == 'block') {
//     //     console.log('currentMealPanel is block');
//     //     currentMealPanel.style.display = 'none';
//     //     destroyAllChildrenOfMealListDisplay(currentMealPanel);
//     // }
...
//         // usesFilteredMeals = false;
//         // useOriginalMealsList = true;
...
//         let mealListPanel = document.getElementById('mealList');
...
//             createMealDispalyPanel(mealsOnThisDate, mealListPanel);
...
//         }
//     }
//     let resp = await fetch('http://localhost:3000/users/edit', {
//         method: 'POST',
//         headers: {
